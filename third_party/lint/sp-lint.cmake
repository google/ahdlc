...
set(SP_LINT_EXECUTABLE "splint" CACHE STRING "full path to the sp-lint executable. NOT the generated lin.bat")
set(SP_LINT_CONFIG_DIR "../../lint/" CACHE STRING "full path to the directory containing sp-lint configuration files")
set(SP_LINT_USER_FLAGS "-predboolint" CACHE STRING "additional pc-lint command line options -- some flags of sp-lint cannot be set in option files (most notably -b)")
...
# 'std.lnt' resides in the configuration directory 'SP_LINT_CONFIG_DIR'. This
...
function(add_sp_lint target)
    ...
    foreach(sourcefile ${ARGN})
        ...
        if( sourcefile MATCHES \\.c$|\\.cxx$|\\.cpp$ )
            ...
            MESSAGE("Checking file:" ${sourcefile_abs}) 
            list(APPEND pc_lint_commands
                COMMAND ${SP_LINT_EXECUTABLE}
                -f ${SP_LINT_CONFIG_DIR}std.lnt
                ${SP_LINT_USER_FLAGS}
